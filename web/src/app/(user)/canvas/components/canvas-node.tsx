                    ...
                    style={
                        {
                            ...
                            animation: data.metadata?.batchRootId ? (batchClosing ? "canvas-batch-child-out 260ms cubic-bezier(.4,0,.2,1) both" : batchOpening ? "canvas-batch-child-in 340ms cubic-bezier(.2,.85,.18,1) both" : undefined) : undefined,
                            animationDelay: data.metadata?.batchRootId && batchOpening ? `${45 + (batchMotion?.index || 0) * 24}ms` : undefined,
